...
--
-- Table structure for table `insurance_subtype`
--
DROP TABLE IF EXISTS `insurance_subtype`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `insurance_subtype` (
  `ins_subtype_id` char(10) NOT NULL,
  `ins_subtype_name` varchar(255) NOT NULL,
  `instype_id` int(10) NOT NULL,
  PRIMARY KEY (`ins_subtype_id`),
  KEY `ins_type_idx` (`instype_id`),
  CONSTRAINT `instype_id` FOREIGN KEY (`instype_id`) REFERENCES `insurance_type` (`instype_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

INSERT INTO `insurance_subtype` VALUES ('1001','个人健康险',0),('1002','个人寿险',0),('1003','个人意外险',0),('1004','个人养老险',0),('2001','团体寿险',1),('2002','团体健康险',1),('2003','团体意外险',1);
...
CREATE TABLE `insurance` (
  ...
  `ins_type` char(10) NOT NULL,
  `ins_pay` varchar(255) NOT NULL,
  `ins_profit` varchar(255) NOT NULL,
  `ins_period` varchar(45) DEFAULT NULL,
  `ins_picture` varchar(45) DEFAULT 'null',
  PRIMARY KEY (`ins_id`),
  KEY `ins_type_idx` (`ins_type`),
  CONSTRAINT `ins_type` FOREIGN KEY (`ins_type`) REFERENCES `insurance_subtype` (`ins_subtype_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

INSERT INTO `insurance` VALUES ('100001','100001','测试保险','1001','100-1000','10000-100000','forever',NULL),
('100002','100002','健康之诺重大疾病保险','1001','5000-10000','30000-100000','forever',NULL),
('100003','100003','百万守护意外伤害保险','1003','50000-150000','200000-1000000','10years',NULL),
('100004','100004','平安寿险','1002','50000-100000','200000-1000000','forever',NULL),
('100005','100005','中国人寿团体寿险','2001','50-100','50000-100000','forever',NULL),
('100006','100005','团体健康保障险','2002','100-10000','50000-1000000','1year',NULL),
('100007','100006','企业团体综合意外险','2003','500-10000','200000-1000000','30days',NULL),
('100008','100002','平安鑫祥养老保险','1004','50000-100000','200000-300000','30years',NULL),
('100009','100005','境外旅游个人险','1003','200-500','5000-100000','15days',NULL),
('100010','100006','境外旅游团体险','2003','200-500','5000-100000','15days',NULL),
('100011','100007','小型团队创业险','2003','500-1000','10000-100000','5years',NULL),
('100012','100003','婴幼儿健康险','1001','5000-10000','50000-200000','3years',NULL),
('100013','100008','短途出差意外险','1003','50-100','10000-200000','5days',NULL),
('100014','100009','全球交通意外险','1003','100-200','50000-500000','180days',NULL),
('100015','100009','境外留学意外险','1003','1000-2000','100000-500000','2years',NULL);
